...
class GestureDetector
{
    ...
    private GESTURE ownGesture = GESTURE.NICHTS;
    private string gestureName = "nichts";
    ...
    public GestureDetector(KinectSensor kinectSensor, GESTURE gestureCode)
    {
        ...
        ownGesture = gestureCode;
        gestureName = gestureList.gestures[(int) ownGesture];
        ...
        using (VisualGestureBuilderFrame frame = frameReference.AcquireFrame())
        {
            if (frame != null)
            {
                ...
                if (discreteResults != null)
                {
                    ...
                    {
                        if (gesture.GestureType == GestureType.Discrete && gesture.Name.Equals(gestureName))
                        {
